    ...
    return (
        <div className="center-container">
            <div className="bg-zinc-800 max-w-md w-full p-10 rounded-md">
                ...
                <h1 className="text-2xl font-light tracking-wide my-2">Register</h1>
                <form onSubmit={onSubmit}>
                    ...
                    <button type="submit" className="bg-violet-600 hover:bg-violet-700 px-4 py-2 rounded-md my-2 text-white">Register</button>
                </form>
